...
export default interface Resources {
  ...
  dashboard: {
    ...
    hero: {
      ...
      firstRunSubtitle: 'Get started with a free OpenCode model — no Claude or Codex login required.';
    ...
    recentProjects: {
      card: {
        deleted: 'Deleted';
        dismiss: 'Remove from recent projects';
        dismissTitle: 'Remove from recent projects';
  ...
  team: {
    ...
    create: {
      ...
      validation: {
        ...
        memberNameInvalid: 'Member name must start with alphanumeric, use only [a-zA-Z0-9._-çğıöşüÇĞİÖŞÜ], max 128 chars';
    ...
    list: {
      ...
      empty: {
        description: 'Your agent teams live here. Start with a kanban board and teammates.';
    ...
    members: {
      ...
      detail: {
        ...
        statInProgress: 'in progress: {{count}}';
        statTasks: 'Tasks';
        statTokens: 'Tokens';
        statUpdated: 'updated {{time}}';
    ...
    messages: {
      ...
      actions: {
        ...
        copiedConversation: 'Conversation copied to clipboard';
    ...
    provisioning: {
      ...
      stall: {
        waiting: 'Waiting for model response ({{elapsed}})…';
        waitingUnusual: 'Still waiting for model response ({{elapsed}}) — this is taking longer than usual';
      };
      steps: {
