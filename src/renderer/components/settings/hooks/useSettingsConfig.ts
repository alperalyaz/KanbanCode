  ...
  const safeConfig = useMemo(
    (): SafeConfig => ({
      ...
      notifications: {
        ...
        notifyOnStatusChange: displayConfig?.notifications?.notifyOnStatusChange ?? false,
        notifyOnTaskComments: displayConfig?.notifications?.notifyOnTaskComments ?? false,
        notifyOnTaskCreated: displayConfig?.notifications?.notifyOnTaskCreated ?? false,
        notifyOnAllTasksCompleted: displayConfig?.notifications?.notifyOnAllTasksCompleted ?? false,
        notifyOnCrossTeamMessage: displayConfig?.notifications?.notifyOnCrossTeamMessage ?? false,
        notifyOnTeamLaunched: displayConfig?.notifications?.notifyOnTeamLaunched ?? false,
